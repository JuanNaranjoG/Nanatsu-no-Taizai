...
export default function Form() {
    ...
    return (
        <form className="form-signin needs-validation" noValidate onSubmit={submit}>
            <h1 className="h3 mb-3 font-weight-normal text-center"><font className="formv"><font className="formv">Agregar Caballero</font></font></h1>
            <div className="mb-2">
            ...
            <div className="mb-2">
                <label htmlFor="inputNombre" className=""><font className="formv"><font className="formv">Raza</font></font></label>
                <input
                    type="text"
                    id="inputEmail"
                    className="form-control"
            ...
            <div className="mb-2">
                <label htmlFor="inputNombre" className=""><font className="formv"><font className="formv">Poder</font></font></label>
                <input
                    type="text"
                    id="inputEmail"
                    className="form-control"
